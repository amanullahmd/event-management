...
import { updateEvent } from '@/lib/utils/api';
import type { UpdateEventRequest, EventResponse, ApiErrorResponse } from '@/lib/types/event-update';
import { isConflictError, isValidationError, isAuthorizationError, isNotFoundError } from '@/lib/types/event-update';
